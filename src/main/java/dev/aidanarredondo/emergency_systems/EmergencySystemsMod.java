...
public class EmergencySystemsMod {
    ...
    public EmergencySystemsMod(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Register all our mod components in the correct order
        ModBlocks.register(modEventBus);           // Blocks first
        ModItems.register(modEventBus);            // Items second (depend on blocks)
        ModBlockEntities.register(modEventBus);    // Block entities third
        ModMenuTypes.register(modEventBus);        // Menus fourth
        ModSounds.register(modEventBus);           // Sounds fifth
        ModCreativeTabs.register(modEventBus);     // Creative tabs last
